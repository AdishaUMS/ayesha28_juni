...
class DXLController:
    ...
    def groupSyncRead(self, address:int, size:int, dxl_id:list, error_bypass:bool=False, error_handle_val:int=0) -> list | int:
        data_res = []
    ...
    def groupBulkRead(self, address:list, size:list, dxl_id:list, error_bypass:bool=False, error_handle_val:int=0) -> list | int:
        param_num   = len(dxl_id)
        data_res    = []
